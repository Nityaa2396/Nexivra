...
const CATEGORY_CONFIG: Record<string, { icon: ReactNode; color: string; bg: string; border: string }> = {
  "first-contact": {
    icon: (
          ...
          return (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
                ...
                <div>
                  <h3 style={{ color: "#fff", fontWeight: 600, fontSize: "16px" }}>{recipe.name}</h3>
                  <p style={{ color: "#71717a", fontSize: "13px" }}>{recipe.description}</p>
                </div>
              </div>
